...
app.get("/generarReporte/:dni", (req, res) => {
    if (req.session.logged) {
        ...
        let query3 = "SELECT estudianteaprendizaje.descripcion, estudianteaprendizaje.estado FROM estudianteaprendizaje INNER JOIN aprendizajes ON estudianteaprendizaje.materia_id = aprendizajes.id_materia  WHERE estudianteaprendizaje.estudiante_dni = ?";
